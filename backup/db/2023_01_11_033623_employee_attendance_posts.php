...
class EmployeeAttendancePosts extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('employee_attendance_posts', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('employee_attendance_posts');
    }
}
