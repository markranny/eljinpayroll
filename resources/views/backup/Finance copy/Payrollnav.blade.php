@include('HR/fmiddlelinkpace')
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="content">
          <div class="container-fluid">
          @if ($message = Session::get('successimportsched'))
          ...
          @endif
          @if ($message = Session::get('errorimportsched'))
          ...
          @endif
          @if ($message = Session::get('exceptionerrorimportsched'))
            <div class="alert alert-danger alert-block">
	            <button type="button" class="close" data-dismiss="alert">&nbsp&nbsp&nbsp&nbsp&nbsp ×</button>	
                <strong>{{ $message }}</strong>
            </div>
          @endif
          @if ($message = Session::get('postsuccesssched'))
          <div class="msg-container" id="postsuccess">
            <div class="alert alert-success alert-block">
	            <button type="button" class="close" data-dismiss="alert">&nbsp&nbsp&nbsp&nbsp&nbsp ×</button>	
                <strong>{{ $message }}</strong>
            </div>
          ...
          @endif
          @if ($message = Session::get('posterror'))
          <div class="msg-container" id="posterror">
            <div class="alert alert-danger alert-block">
	            <button type="button" class="close" data-dismiss="alert">&nbsp&nbsp&nbsp&nbsp&nbsp ×</button>	
                <strong>{{ $message }}</strong>
            </div>
