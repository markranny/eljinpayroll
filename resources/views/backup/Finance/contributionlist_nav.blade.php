@include('HR/firstpace')
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">CONTRIBUTION LISTS</a>
          </div>
      ...
      <div class="content">
        <div class="content">
          <div class="container-fluid">
          @if ($message = Session::get('uploademployee'))
          ...
          @endif
          @if ($message = Session::get('erroruploademployee'))
          ...
          @endif
          @if ($message = Session::get('exceptionerroruploademployee'))
            <div class="alert alert-danger alert-block">
	            <button type="button" class="close" data-dismiss="alert">&nbsp&nbsp&nbsp&nbsp&nbsp ×</button>	
                <strong>{{ $message }}</strong>
            </div>
          @endif
          @if ($message = Session::get('postsuccessemployee'))
          ...
          @include('layouts.contributionlists') 
