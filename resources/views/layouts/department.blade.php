...
<div class="card">
        <div class="card-body">
            ...
            <div class="float-right">
                <div class="row">
                <div class="col-2">
                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModal">ADD DEPARTMENT</button>
     ...
     <div class="card">
        <div class="card-body">
            <div class="material-datatables">
                <table id="department" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                    <thead>
                        <tr>
                        <th>ID</th>
                        <th>DEPCODE</th>
	...
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
                <form method="POST" action="{{ route('adddep') }}" enctype="multipart/form-data" target="_blank">
                @csrf  
            ...
            <div class="row">
                ...
                <div class="form-group">
                    <input type="text" name="dep_code" class="form-control" placeholder="ENTER DEPCODE" style='text-transform:uppercase'><br>
                </div>
                </div>

                <div class="col-12">
                <div class="form-group">
                    <input type="text" name="department" class="form-control" placeholder="ENTER DEPARTMENT" style='text-transform:uppercase'><br>
                </div>
                </div>
